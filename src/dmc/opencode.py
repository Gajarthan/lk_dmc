...
SYSTEM_PROMPT = (
    ...
    "Produce one report analysis object matching the provided schema. "
    "Do not return the schema itself. Write analysis values in English, "
    "preserving place names and exact numbers. "
